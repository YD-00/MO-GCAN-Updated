...
cna_embedding =  normalize(cna_model.forward(cna_data[x_train.index], train_lap[0]))
met_embedding =  normalize(met_model.forward(met_data[x_train.index], train_lap[1]))
mrna_embedding =  normalize(mrna_model.forward(mrna_data[x_train.index], train_lap[2]))
rppa_embedding =  normalize(rppa_model.forward(rppa_data[x_train.index], train_lap[3]))
...
test_cna_embedding =  normalize(cna_model.forward(cna_data[x_test.index], test_lap[0]))
test_met_embedding =  normalize(met_model.forward(met_data[x_test.index], test_lap[1]))
test_mrna_embedding =  normalize(mrna_model.forward(mrna_data[x_test.index], test_lap[2]))
test_rppa_embedding =  normalize(rppa_model.forward(rppa_data[x_test.index], test_lap[3]))
