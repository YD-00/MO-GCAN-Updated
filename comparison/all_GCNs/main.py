...
final_model,final_train_acc = train_model('GCN',100,hidden_embeddings,train_fused_net,labels[x_train.index])
...
if (len(indices) < 4):
    ...
    final_selected_model,final_selected_train_acc = train_model('GCN',100,selected_embeddings,selected_train_fused_net,labels[x_train.index])
